...
class DeliveryServiceTest {
  ...
  void findRiders() {
    RiderSearchRequest searchRequest = RiderSearchRequest.builder()
        .lng(50.0).lat(0).radius(10).count(1).build();
    UniAssertSubscriber<List<String>> subscriber = this.deliveryService.updateRiderPosition(
    ...
    subscriber = this.deliveryService.disableRider(
        DisableRiderRequest.newBuilder()
            .setRiderId("rider1")
            .build())
