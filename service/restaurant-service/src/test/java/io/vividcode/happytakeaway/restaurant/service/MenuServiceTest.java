...
class MenuServiceTest {
  ...
  void updateMenu() {
    ...
    String menuId = this.menuService
        .createMenu(TestHelper.createMenuRequest(restaurantId, false));
    String newName = "new";
    UpdateMenuResponse response = this.menuService
        .updateMenu(TestHelper.updateMenuRequest(restaurantId, menuId, newName));
  ...
  void associateMenuItems() {
    ...
    String menuId = this.menuService
        .createMenu(TestHelper.createMenuRequest(restaurantId, false));
    Set<String> menuItemIds = IntStream.range(0, 10).mapToObj(
    ...
    PagedResult<MenuItem> pagedResult = this.menuItemService
        .findMenuItems(menuId, PageRequest.of(0, 5));
